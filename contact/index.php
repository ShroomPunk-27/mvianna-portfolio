...
<body>
    ...
    <div class="contact_form">
        ...
        htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <p>
                    <label for="instagram"><b>I. </b>Instagram Handle:</label>
            ...
            <?php
                ...
                $stmt = $mysqli->prepare("INSERT INTO `clients` (`c_name`, `at_ig`, `email`) VALUES (?, ?, ?)");
                $stmt->execute([$name, $instagram, $email]);

                $stmt2 = $mysqli->prepare("INSERT INTO `commish` (`client`, `delivery_date`, `client_refs`, `description`) VALUES (?, ?, ?, ?)");
                $stmt2->execute([$name, $deadline, $reference_link, $description]);
            ?>
        </form>
    </div>
